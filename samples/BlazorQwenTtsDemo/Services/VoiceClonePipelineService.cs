...
/// <summary>
/// Singleton service wrapping VoiceClonePipeline with thread-safe access for the sample host.
...
public sealed class VoiceClonePipelineService : IDisposable
{
    ...
    /// <summary>
    /// Initialize the voice cloning pipeline, downloading voice-cloning models if needed.
    /// </summary>
