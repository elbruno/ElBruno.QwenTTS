...
This fixes the 'invalid expand shape' error in the Expand node of the code_predictor.onnx
when using ONNX Runtime in C#.
"""
...
if __name__ == '__main__':
    ...
    model = Qwen3TTSForConditionalGeneration.from_pretrained(
        'python/models/Qwen3-TTS-0.6B-Base',
        dtype=torch.float32,
