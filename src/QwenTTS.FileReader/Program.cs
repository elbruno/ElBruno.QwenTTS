...
namespace QwenTTS.FileReader;

/// <summary>
/// CLI app that reads a text or SRT file and generates speech audio for each segment.
/// Usage: QwenTTS.FileReader --model-dir ./models --input file.txt --speaker ryan [--language auto] [--output-dir ./output] [--instruct "speak calmly"]
/// </summary>
public static class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        {
            Console.Error.WriteLine("Usage: QwenTTS.FileReader --model-dir ./models --input file.txt --speaker ryan [--language auto] [--output-dir ./output] [--instruct \"speak calmly\"]");
            return 1;
        }
